...
#define GET_MASK(buf, pos) (!!((buf)[(pos)/8] & (1 << ((pos)%8))))
    ...
    #define DISPLAY_OUTPUT_BUFFER_BASED_ON_CHARACTER
...
#define STRCPY_TEXTBUF(dst, txt, len)
    ...
    #define DISPLAY_CHAR_BUF_SIZE (DISPLAY_FRAME_WIDTH_CHAR * DISPLAY_FRAME_HEIGHT_CHAR)
        ...
        // TODO: Review this. Why is this different?
            ...
            #define DISPLAY_OUT_BUF_SIZE (DISPLAY_CHAR_BUF_SIZE * DIV_CEIL(CONFIG_DISPLAY_FRAMEBUF_BITS_PER_CHAR, 8))
        #else
            #define DISPLAY_OUT_BUF_SIZE (DIV_CEIL(DISPLAY_CHAR_BUF_SIZE * CONFIG_DISPLAY_FRAMEBUF_BITS_PER_CHAR, 8))
        #endif
    #endif
#endif
    ...
    #define SHADER_INCLUDE CONFIG_DISPLAY_SHADER_INCLUDE
#endif