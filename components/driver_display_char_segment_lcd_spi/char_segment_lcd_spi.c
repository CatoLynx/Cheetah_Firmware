...
void cseg_lcd_latch_indicators(void) {
    #if defined(CONFIG_DISPLAY_LINE_FLAGS_INDICATOR_LIGHT)
    gpio_pulse_inv(CONFIG_CSEG_LCD_LATCH_INDICATOR_IO, 1, CONFIG_CSEG_LCD_LATCH_PULSE_LENGTH, CONFIG_CSEG_LCD_LATCH_PULSE_LENGTH, CONFIG_CSEG_LCD_LATCH_INDICATOR_INV);
    #endif
}
