...
#if defined(CONFIG_CSEG_LCD_SPI_MODE_0)
#define CONFIG_CSEG_LCD_SPI_MODE 0
#elif defined(CONFIG_CSEG_LCD_SPI_MODE_1)
#define CONFIG_CSEG_LCD_SPI_MODE 1
#elif defined(CONFIG_CSEG_LCD_SPI_MODE_2)
#define CONFIG_CSEG_LCD_SPI_MODE 2
#elif defined(CONFIG_CSEG_LCD_SPI_MODE_3)
#define CONFIG_CSEG_LCD_SPI_MODE 3
#endif
