...
config_entry_t config_entries[] = {
    ...
    {.key = "tg_log_chnl_en",  .dataType = U8 , .flags = BC_FIELD_FLAGS_BOOLEAN, .comment = "Enable logging to Telegram channel"},
    ...
    {.key = "playlist_active", .dataType = U8,  .flags = BC_FIELD_FLAGS_BOOLEAN, .comment = "Enable playlist playback"},
