...
config_entry_t config_entries[] = {
    ...
    {.key = "tg_log_chnl_id",  .dataType = STR, .flags = BC_FIELD_FLAGS_NONE, .comment = "Chat ID of channel to log received texts to"},
    {.key = "tg_log_chnl_en",  .dataType = U8 , .flags = BC_FIELD_FLAGS_NONE, .comment = "1 to enable logging to channel, 0 to disable"},
